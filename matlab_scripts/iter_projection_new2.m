...
function [A, converged] = iter_projection_new2(X, S, D, A, w, t, maxiter)  
...
% w: a weight vector originated from similar data (see paper)- see the
...
while (~done)
 ...
 %[error1, error2]
  ...
  % and such projection improves objective function, 
  % slightly increase learning rate, and update from the current A
