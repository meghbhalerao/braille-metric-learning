...
X_sum_unroll(7,:) = unroll(X_sum_temp)';
X_sum_temp = 0;
...
X_sum_unroll(8,:) = unroll(X_sum_temp)';
X_sum_temp = 0;
...
X_sum_unroll(9,:) = unroll(X_sum_temp)';
X_sum_temp = 0;
...
X_sum_unroll(10,:) = unroll(X_sum_temp)';
X_sum_temp = 0;
...
X_sum_unroll(11,:) = unroll(X_sum_temp)';
X_sum_temp = 0;
...
X_sum_unroll(12,:) = unroll(X_sum_temp)';
X_sum_temp = 0;
...
X_sum_unroll(13,:) = unroll(X_sum_temp)';
X_sum_temp = 0;
...
X_sum_unroll(14,:) = unroll(X_sum_temp)';
...
X_sum_unroll(15,:) = unroll(X_sum_temp)';
% X_sum_temp = 0;
 E = [];
Co = Cf5;
 Cf5 = (Cf5 + Cf5')/2;
...
% accuracy check
%code for generation of triplets
